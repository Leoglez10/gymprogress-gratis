      ...
      <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 mb-6">
        <form onSubmit={handleSave} className="space-y-4">
          <div className="flex justify-center mb-6">
             <div className="h-24 w-24 bg-blue-600 rounded-full flex items-center justify-center text-3xl font-bold overflow-hidden border-4 border-slate-700 shadow-xl">
                {formData.photoUrl ? (
          ...
          <div>
            <label className="block text-slate-400 text-xs uppercase font-bold mb-2">URL Foto de Perfil</label>
            <input 
              type="url" 
              name="photoUrl"
              ...
              className="w-full bg-slate-900 border border-slate-600 rounded p-3 text-white focus:border-blue-500 focus:outline-none transition-colors"
            />
            <p className="text-[10px] text-slate-500 mt-1">Pega una URL de imagen para usarla como avatar.</p>
          </div>
